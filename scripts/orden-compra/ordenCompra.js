        ...
        data.forEach((ordenCompra, index) => {
            content += `
                <tr>
                    ...
                    <td class="text-center">${ordenCompra.moneda?.mon_descripcion ?? 'No aplica'}</td>
                    <td class="text-center">${ordenCompra.occ_subtotal}</td>
                    ...
                    <td>${ordenCompra.occ_estado == '1' ? 'Activo' : 'Inactivo'}</td>
                    <td>
