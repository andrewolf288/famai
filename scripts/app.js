document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ruta para el detalle de orden interna
    router.on('/orden-interna/detalle/:id', () => {
        privateRoute(() => {
            loadContent('pages/orden-interna/detalleOrdenInterna.html', 'scripts/orden-interna/detalleOrdenInterna.js')
        })
    })
    ...
    // Ruta de emision de nota de ingreso
    router.on('/emision-nota-salida', () => {
        privateRoute(() => {
            loadContent('pages/emision-nota-salida/emisionNotaSalida.html', 'scripts/emision-nota-salida/emisionNotaSalida.js')
        })
    })
