                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-around">
                            <button class="btn btn-sm btn-warning btn-cotizacion-editar me-1" data-cotizacion="${cotizacion.coc_id}">
                            ...
                            <a class="btn btn-sm btn-outline-primary btn-cotizacion-visualizar" target="_blank" href="${config.FRONT_URL}/cotizacion-proveedor.html?coc_id=${cotizacion.coc_id}">
