...
Route::group(['middleware' => ['auth.jwt']], function () {
    ...
    Route::get('detalleMaterialesOrdenInterna/ajustar-material/{id}', [OrdenInternaMaterialesController::class, 'ajustarMaterial']);
});
...
Route::group(['middleware' => ['auth.jwt']], function () {
    ...
    Route::get('ordenescompra/{id}/adjuntos', [OrdenCompraController::class, 'getAdjuntos']);
    Route::get('ordenescompra/adjuntos/descargar', [OrdenCompraController::class, 'descargarAdjunto']);
});
...
Route::get('productoByCodigoPublico', [ProductoController::class, 'findProductoByCodigo']);
