...
class AlmacenMovimientoController extends Controller
{
    ...
    public function ingresoAlmacenMovimiento(Request $request)
    {
        ...
        try {
            ...
            return response()->json(["success" => "Nota de ingreso creada con exito"], 200);
        } catch (Exception $e) {
            DB::rollBack();
    ...
    public function salidaAlmacenMovimiento(Request $request)
    {
        ...
        try {
            ...
            return response()->json(["success" => "Nota de salida creada con exito"], 200);
        } catch (\Illuminate\Database\QueryException $e) { // Captura errores de SQL
            DB::rollBack();
            $message = $e->errorInfo[2] ?? "Error desconocido";
            return response()->json([
                "error" => $message
            ], 500);
        } catch (Exception $e) {
