...
<body>
    ...
    <table class="table-container-detalle" style="margin-top: 5px;">
        <thead>
            <tr>
                ...
                @if ($countMateriales != 0 || $countProcesos != 0)
                    ...
                    @endphp
                        <tr>
                            ...
                            {{-- PROCESOS --}}
                            @if ($i < $countProcesos)
                                <td rowspan="{{ $i == $countProcesos - 1 ? $maximoCount - $i : 1 }}" style="text-align: center;">{{$parte['detalle_procesos'][$i]['opp_codigo']}}</td>
                                <td rowspan="{{ $i == $countProcesos - 1 ? $maximoCount - $i : 1 }}">{{$parte['detalle_procesos'][$i]['odp_descripcion']}}</td>
                                <td rowspan="{{ $i == $countProcesos - 1 ? $maximoCount - $i : 1 }}">{{$parte['detalle_procesos'][$i]['odp_observacion']}}</td>
                            ...
                            @if ($i < $countMateriales)
                                <td rowspan="{{ $i == $countMateriales - 1 ? $maximoCount - $i : 1 }}" style="text-align: center;">{{$parte['detalle_materiales'][$i]['pro_codigo']}}</td>
                                <td rowspan="{{ $i == $countMateriales - 1 ? $maximoCount - $i : 1 }}" style="font-weight: {{$fontWeight}};">{{$parte['detalle_materiales'][$i]['odm_descripcion']}}</td>
                                <td rowspan="{{ $i == $countMateriales - 1 ? $maximoCount - $i : 1 }}" style="text-align: center;">{{$parte['detalle_materiales'][$i]['odm_cantidad']}}</td>
                                <td rowspan="{{ $i == $countMateriales - 1 ? $maximoCount - $i : 1 }}" style="background-color: {{ $colorObservacion }}; font-weight: {{$fontWeight}};">{{$parte['detalle_materiales'][$i]['odm_observacion']}}</td>
